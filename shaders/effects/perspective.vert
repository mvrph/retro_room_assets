...
uniform float g_Top; // {"material":"top","label":"ui_editor_properties_top","default":0,"range":[-0.49,0.49]}
uniform float g_Bottom; // {"material":"bottom","label":"ui_editor_properties_bottom","default":0,"range":[-0.49,0.49]}
uniform float g_Left; // {"material":"left","label":"ui_editor_properties_left","default":0,"range":[-0.49,0.49]}
uniform float g_Right; // {"material":"right","label":"ui_editor_properties_right","default":0,"range":[-0.49,0.49]}
