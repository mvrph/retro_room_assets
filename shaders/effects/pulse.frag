...
#if MASK == 1
uniform sampler2D g_Texture2; // {"material":"mask","label":"ui_editor_properties_opacity_mask","mode":"opacitymask","combo":"MASK","default":"util/white","paintdefaultcolor":"0 0 0 1"}
#endif
